...
expName = 'rptest'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\e203gtec\\Desktop\\mstembci\\Sternberg_2\\testing\\rptest_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    if resp.maxDurationReached:
        routineTimer.addTime(-resp.maxDuration)
    elif resp.forceEnded:
        routineTimer.reset()
    else:
